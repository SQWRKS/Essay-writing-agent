...
// Use nullish coalescing so that an empty string (relative-URL mode) is kept,
// and strip any trailing slash to avoid double-slash in constructed URLs.
const SSE_BASE_URL = (api.defaults.baseURL ?? '').replace(/\/$/, '')
